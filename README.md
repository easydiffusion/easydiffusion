...
- **No Dependencies or Technical Knowledge Required**: 1-click install for Windows 10/11 and Linux. _No dependencies_, no need for WSL or Docker or Conda or technical setup. Just download and run!
...
- Supports "_Text to Image_" and "_Image to Image_"
