...
### Detailed changelog
* 2.6.0 - 3 Aug 2023 - Enabled diffusers for everyone by default. The old v2.5 engine can be used by disabling the "Use v2.6 engine" option in the Settings tab.
