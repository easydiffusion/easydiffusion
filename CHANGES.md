...
* 2.5.16 - 10 Feb 2023 - Allow a server to disable auto-saving images from the Settings tab. This can be set in the `config.json` file as `force_save_path: False`. Thanks @JeLuf.
