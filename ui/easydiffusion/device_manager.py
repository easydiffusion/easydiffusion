...
def needs_to_force_full_precision(context):
    ...
    return (('nvidia' in device_name or 'geforce' in device_name) and (' 1660' in device_name or ' 1650' in device_name or ' t400' in device_name or ' t550' in device_name or ' t600' in device_name or ' t1200' in device_name)) or ('Quadro T2000' in device_name)
