...
@REM @copy sd-ui-files\scripts\get_config.py scripts\ /Y
@REM @copy sd-ui-files\scripts\config.yaml.sample scripts\ /Y
@REM @copy sd-ui-files\scripts\webui_console.py scripts\ /Y
